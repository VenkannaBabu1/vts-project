                                ...
                                requests.length > 0 ? (
                                    requests.map((req, index) =>
                                        <tr key={req.id}>
                                            ...
                                            <td>{req.policyId}</td>
                                            <td>{req.policyNo}</td>
                                            <td>{req.policyName}</td> {/* //policyName will be displayed here but variable is destination */}
                                            <td>{req.destination}</td>{/* //destination will be displayed here but variable is policyname */}
