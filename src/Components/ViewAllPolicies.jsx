            ...
            {policies.map((policy, index) => (
              <li key={index}>
                ...
                <div >
                  ...
                  <button
                    className="sea1 w-[230px] ml-1 mt-1 bg-orange-500 hover:bg-orange-500 hover:text-white rounded-xl pb:2"
                    onClick={() => handleClick(policy.id, policy.type, policy.policyId, policy.policyName, policy.coverage, policy.description)}
                  >
                    Edit now
                  </button>
                  <button className=" w-[230px] ml-1 bg-purple-500 mt-1 hover:bg-orange-500 hover:text-white rounded-xl pb:1" onClick={() => handleDelete(policy.id)}> Delete</button>
                </div>
